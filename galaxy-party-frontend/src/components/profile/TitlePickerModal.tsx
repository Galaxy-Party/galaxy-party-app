    ...
    return (
        ...
        >
            <div
                ...
                className="card-in bg-[rgba(12,8,28,0.96)] border border-[rgba(129,140,248,0.22)] rounded-[24px] px-[40px] py-[36px] min-w-[380px] max-w-[460px] shadow-[0_24px_60px_rgba(0,0,0,0.7)] max-h-[80vh] flex flex-col"
            >
                <div className="font-display font-bold text-[20px] text-[#818cf8] mb-1.5">Choisir un titre</div>
                <div className="text-[13px] text-[rgba(241,240,255,0.35)] mb-6">Sélectionnez le titre à afficher sur votre profil</div>

                <div className="scrollbar-indigo overflow-y-auto flex-1 flex flex-col gap-2">
                    {levels.map(l => {
                        ...
                        return (
                            <div
                                ...
                                className={`flex items-center gap-3 px-4 py-3 rounded-[14px] border transition-all duration-200 ${locked ? 'cursor-default border-[rgba(129,140,248,0.1)] bg-[rgba(12,8,28,0.4)]' : highlighted ? 'cursor-pointer border-[#818cf8] bg-[rgba(129,140,248,0.1)]' : 'cursor-pointer border-[rgba(129,140,248,0.22)] bg-[rgba(12,8,28,0.4)]'}`}
                            >
                                <span
                                ...
                                <div
                                    ...
                                    style={{ color: locked ? 'rgba(241,240,255,0.45)' : 'rgba(241,240,255,0.35)' }}
                                >
