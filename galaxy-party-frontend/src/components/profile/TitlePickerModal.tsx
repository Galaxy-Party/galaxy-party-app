    ...
    return (
        ...
        >
            <div
                ...
                className="card-in bg-[rgba(12,8,28,0.96)] border border-[rgba(129,140,248,0.22)] rounded-[24px] px-[40px] py-[36px] min-w-[380px] max-w-[460px] shadow-[0_24px_60px_rgba(0,0,0,0.7)] max-h-[80vh] flex flex-col overflow-hidden"
            >
                    ...
                    {levels.map(l => {
                        ...
                        return (
                            <div
                                ...
                                className={`flex items-center gap-3 px-4 py-3 rounded-[14px] border transition-all duration-200 ${locked ? 'cursor-default border-[rgba(129,140,248,0.2)] bg-[rgba(12,8,28,0.4)]' : highlighted ? 'cursor-pointer border-[#818cf8] bg-[rgba(129,140,248,0.1)]' : 'cursor-pointer border-[rgba(129,140,248,0.4)] bg-[rgba(12,8,28,0.4)]'}`}
                            >
                                <span
