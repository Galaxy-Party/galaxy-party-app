      ...
      <div className="scrollbar-indigo" style={{ padding: '28px 32px 32px', maxHeight: 'calc(100vh - 280px)', overflowY: 'auto' }}>
        {[
          ...
          <div key={section.title} style={{ marginBottom: 22 }}>
            <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: 11, fontWeight: 700, letterSpacing: '0.18em', textTransform: 'uppercase', color: ROSE, marginBottom: 14, display: 'flex', alignItems: 'center', gap: 10 }}>
              {section.title}
